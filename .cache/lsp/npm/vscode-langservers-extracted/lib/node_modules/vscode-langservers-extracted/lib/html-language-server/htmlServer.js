...
function startServer(connection, runtime) {
  ...
  connection.onInitialize(function (params) {
    var _initializationOption, _params$initializatio, _params$initializatio2, _params$initializatio3, _params$initializatio4, _params$initializatio5;
    ...
    formatterMaxNumberOfEdits = ((_params$initializatio = params.initializationOptions) === null || _params$initializatio === void 0 ? void 0 : (_params$initializatio2 = _params$initializatio.customCapabilities) === null || _params$initializatio2 === void 0 ? void 0 : (_params$initializatio3 = _params$initializatio2.rangeFormatting) === null || _params$initializatio3 === void 0 ? void 0 : _params$initializatio3.editLimit) || Number.MAX_VALUE;
    var capabilities = {
      ...
      documentRangeFormattingProvider: ((_params$initializatio4 = params.initializationOptions) === null || _params$initializatio4 === void 0 ? void 0 : _params$initializatio4.provideFormatter) === true,
      documentFormattingProvider: ((_params$initializatio5 = params.initializationOptions) === null || _params$initializatio5 === void 0 ? void 0 : _params$initializatio5.provideFormatter) === true,
  ...
  connection.onDidChangeConfiguration(function (change) {
    ...
    documents.all().forEach(triggerValidation); // dynamically enable & disable the formatter
