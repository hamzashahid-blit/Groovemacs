...
(function (Diagnostics) {
  ...
  function create(settings, problem) {
...
(function (ESLint) {
  ...
  function resolveSettings(document) {
    ...
    resultPromise = connection.workspace.getConfiguration({
      ...
      return promise.then( /*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(libraryPath) {
          var library, _filePath, parserRegExps, pluginName, parserOptions, eslintConfig, parser, _eslintConfig$parserO, _iterator7, _step7, regExp, _iterator9, _step9, name, params, Uri, isFile, pattern, filter, options, _filePath2;
            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                ...
                case 13:
                  ...
                  _context7.next = 16;
                  return ESLint.withClass(function (eslintClass) {
                    try {
                ...
                case 60:
                  if (!(settings.format && settings.validate === settings_1.Validate.on && TextDocumentSettings.hasLibrary(settings))) {
                    _context7.next = 74;
                    break;
                  }
                ...
                case 74:
                  return _context7.abrupt("return", settings);
          ...
          }, _callee7, null, [[22, 33, 36, 39], [42, 53, 56, 59]]);
        }));
  ...
  function withClass(func, settings, options) {
    ...
    try {
      if (settings.workingDirectory) {
        ...
        var newCWD = (0, paths_1.normalizeDriveLetter)(settings.workingDirectory.directory);
      ...
      var eslintClass = newClass(settings.library, newOptions, settings.useESLintClass);
  ...
  function _validate() {
    _validate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(document, settings) {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return _context9.abrupt("return", withClass( /*#__PURE__*/function () {
                var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(eslintClass) {
                    ...
                    while (1) {
                      switch (_context8.prev = _context8.next) {
                        ...
                        case 3:
                          ...
                          if (reportResults && Array.isArray(reportResults) && reportResults.length > 0) {
                            ...
                            if (docReport.messages && Array.isArray(docReport.messages)) {
                              docReport.messages.forEach(function (problem) {
                                if (problem) {
                                  var _Diagnostics$create = Diagnostics.create(settings, problem),
                          ...
                          return _context8.abrupt("return", diagnostics);
  ...
  (function (ErrorHandlers) {
    ...
    function clearNoConfigRepoerted() {
      noConfigReported.clear();
    }

    ErrorHandlers.clearNoConfigRepoerted = clearNoConfigRepoerted;
    ...
    function showErrorMessage(error, document) {
      ...
      if (!ignoredErrors.has(errorMessage)) {
        ...
        void (_connection$window = connection.window).showErrorMessage.apply(_connection$window, [errorMessage].concat(actions)).then(function (value) {
          if (value !== undefined) {
            if (value.id === 1) {
              void connection.sendNotification(customMessages_1.ShowOutputChannel.type);
            } else if (value.id === 2) {
