...
* Install Instructions
    Clone this Git repo to your =~/.emacs.d=
	!!!IMPORTANT NOTE!!! Make a backup if you already have =~/.emacs.d=
	git clone https://github.com/hamzashahid-blit/.emacs.d ~/.emacs.d

	After you launch, answer some basic yes/no questions.

	Now run the below command in emacs to make sure all icons are correctly installed
...
* Delimiters
  #+begin_src emacs-lisp
    ...
    ;;; Everything below is basically replaced with ParEdit
